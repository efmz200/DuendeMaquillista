        ...
        <Fragment>
                                ...
                                <div class="p-6">
                                    ...
                                    <div class="sm:order-1 inline-block">
                                        <div class="mx-auto flex h-8 items-stretch text-gray-600">
                                            <button class="flex items-center justify-center rounded-l-md bg-black px-4 transition hover:bg-green hover:text-white text-white">-</button>
                                            <div class="flex w-12 items-center justify-center bg-darkGreen px-4 text-xs uppercase transition text-white">1</div>
                                            <button class="flex items-center justify-center rounded-r-md bg-black px-4 transition hover:bg-green hover:text-white text-white">+</button>
                                        </div>
                                    </div>
            ...
            <Modal isVisible={showModalEdit} onClose={() => setShowModalEdit(false)}>
                <div className="p-6">
                    <form className="space-y-2">
                        <div>
                            <h3 className='text-center text-2xl font-semibold text-white'>Editar Producto</h3>
                        </div>
                        ...
                        <input name='cantidad' type='number' required value={cantidadProducto} onChange={(e) => setCantidadProducto(e.target.value)}
                            className='appearance-none block w-full px-3 py-2 border border-gray-200 rounded-md shadow-sm placeholder-gray-800 focus:outline-none focus:ring-green focus:border-green sm:text-sm' placeholder="Cantidad Producto" />

                        <input name='precio' type='number' required value={precio} onChange={(e) => setPrecio(e.target.value)}
                            className='appearance-none block w-full px-3 py-2 border border-gray-200 rounded-md shadow-sm placeholder-gray-800 focus:outline-none focus:ring-green focus:border-green sm:text-sm' placeholder="Precio Producto" />
            ...
            <Modal isVisible={showModalAdd} onClose={() => setShowModalAdd(false)}>
                <div className="p-6">
                    <form className="space-y-2">
                        <div>
                            <h3 className='text-center text-2xl font-semibold text-white'>Agregar Producto Inventario</h3><br />
                        </div>

                        <input name='nombreProducto' type='text' required value={nombreProducto} onChange={(e) => setNombreProducto(e.target.value)}
                            className='appearance-none block w-full px-3 py-2 border border-gray-200 rounded-md shadow-sm placeholder-gray-800 focus:outline-none focus:ring-green focus:border-green sm:text-sm' placeholder="Nombre Producto" />
                        ...
                        <input name='cantidadProducto' type='text' required value={cantidadProducto} onChange={(e) => setCantidadProducto(e.target.value)}
                            className='appearance-none block w-full px-3 py-2 border border-gray-200 rounded-md shadow-sm placeholder-gray-800 focus:outline-none focus:ring-green focus:border-green sm:text-sm' placeholder="Cantidad Producto" />

                        <input name='precio' type='text' required value={precio} onChange={(e) => setPrecio(e.target.value)}
                            className='appearance-none block w-full px-3 py-2 border border-gray-200 rounded-md shadow-sm placeholder-gray-800 focus:outline-none focus:ring-green focus:border-green sm:text-sm' placeholder="Precio Producto" />
